...
public class IntakePanOIControl extends Command {
  ...
  protected void execute() {
    if(!(Robot.intakePan.getLimitLeft() || Robot.intakePan.getLimitRight())){
      Robot.intakePan.set(Robot.m_oi.getTriggerRight() - Robot.m_oi.getTriggerLeft());
    }
    else if(Robot.intakePan.getLimitLeft()){
      Robot.intakePan.set(Robot.m_oi.getTriggerRight());
    }
    else{
      Robot.intakePan.set(-Robot.m_oi.getTriggerLeft());
    }
